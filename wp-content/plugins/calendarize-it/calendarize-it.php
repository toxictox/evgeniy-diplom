...
/**
Plugin Name: Calendarize it! for WordPress |  VestaThemes.com
Plugin URI: http://plugins.righthere.com/calendarize-it/
Description: Calendarize it! The most flexible and feature-rich calendar solution available for WordPress (with support for WPBakery Page Builder formerly Visual Composer)
Version: 4.6.5.83180
Author: Alberto Lau (RightHere LLC)
Author URI: http://plugins.righthere.com
 **/
 
define('RHC_VERSION','4.6.5'); 
