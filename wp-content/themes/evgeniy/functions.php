...
if ( ! function_exists( 'activello_header_search_filter' ) ) {
	function activello_header_search_filter( $form ) {
		$form = '<form action="' . esc_url( home_url( '/' ) ) . '" method="get"><input type="text" name="s" value="' . get_search_query() . '" placeholder="Поиск"><button type="submit" class="header-search-icon" name="submit" id="searchsubmit" value="Искать"><i class="fa fa-search"></i></button></form>';
		return $form;
	}
}
